...
# my $upload_filehandle = $query->upload("structureZipFile"); commeted out by Josef
my $zipServerLocation = "$curJobdir/Structure_toy_data_tiny.zip";
...
# added by Josef
copy (CLUMPAK_CONSTS_and_Functions::DAILY_TEST_STRUCTURE_FILE, $zipServerLocation);
